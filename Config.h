...
#include "Globals.h"
#include "lib/MathGeoLib/include/Math/Math.h"
...
public:
	...
	RID GetRID(const char* field, RID default = 0, int index = -1) const;
	...
	bool AddUID(const char* field, RID value);
	...
	bool AddArrayRID(const char* field, const RID* values, int size);
